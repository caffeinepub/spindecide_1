...
function Confetti({ active, duration = 3500 }) {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                "data-ocid": "nav.link",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 20, className: "text-primary", fill: "currentColor" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "SpinDecide" })
                ]
              }
            ),
...
function QuickDecisions({ onResult }) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            style: { color: "oklch(var(--muted-foreground))" },
            children: "One tap. Instant answer. No overthinking."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4 sm:grid-cols-2 lg:grid-cols-4", children: CARDS.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl", role: "img", "aria-label": card.label, children: card.emoji }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold text-foreground sm:text-lg", children: card.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
...
function getEmoji(result) {
  ...
  if (lower.includes("pizza") || lower.includes("food") || lower.includes("eat"))
    return "🍕";
  if (lower.includes("yes")) return "✅";
  if (lower.includes("no")) return "❌";
  if (lower.includes("study")) return "📚";
  if (lower.includes("chill")) return "🛋️";
  if (lower.includes("movie") || lower.includes("watch") || lower.includes("netflix"))
    return "🎬";
...
function ResultCard({ result, category, onReset }) {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            background: "linear-gradient(135deg, oklch(0.80 0.09 183), oklch(0.72 0.12 189))",
            boxShadow: "0 20px 60px oklch(0.70 0.11 189 / 0.3), 0 4px 20px rgba(0,0,0,0.2)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3 text-5xl", role: "img", "aria-label": result, children: emoji }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
...
function SpinWheel({
  ...
  const rafRef = reactExports.useRef(0);
  const canSpinRef = reactExports.useRef(true);
  const [size, setSize] = reactExports.useState(320);
  reactExports.useEffect(() => {
    const update = () => {
      setSize(
  ...
  const drawWheel = reactExports.useCallback(
    (ctx, angle, opts, highlightIdx = null) => {
      ...
      for (let i = 0; i < n; i++) {
        ...
        ctx.textAlign = "right";
        ctx.fillStyle = highlightIdx === i ? "#1a1a2e" : TEXT_COLORS[color] || "#fff";
        const maxLen = r - 28;
  ...
  const spin = reactExports.useCallback(() => {
    ...
    const ctx = canvas.getContext("2d");
    if (!ctx) return;
    const opts = options.length >= 2 ? options : ["Option A", "Option B", "Option C"];
    ...
    const animate = (now2) => {
      ...
      if (t < 1) {
        ...
        const n = opts.length;
        const segAngle = 2 * Math.PI / n;
        const pointerInWheel = (-targetAngle % (2 * Math.PI) + 2 * Math.PI) % (2 * Math.PI);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "canvas",
      {
        ...
        style: {
          filter: isSpinning ? "brightness(1.05)" : void 0,
...
function useDailyCount() {
  const [data, setData] = useLocalStorage("spinDecide_dailyCount", {
    date: today(),
    count: 0
  });
...
function playSpinSound(duration = 3.5) {
  ...
  osc.frequency.exponentialRampToValueAtTime(200, now2 + duration);
  gainNode.gain.setValueAtTime(0, now2);
  gainNode.gain.linearRampToValueAtTime(0.18, now2 + 0.05);
  gainNode.gain.exponentialRampToValueAtTime(1e-3, now2 + duration);
  osc.start(now2);
...
function playResultSound() {
  ...
  freqs.forEach((freq, i) => {
    ...
    gain.gain.setValueAtTime(0, now2 + i * 0.06);
    gain.gain.linearRampToValueAtTime(0.12, now2 + i * 0.06 + 0.02);
    gain.gain.exponentialRampToValueAtTime(1e-3, now2 + i * 0.06 + 0.5);
    osc.start(now2 + i * 0.06);
    osc.stop(now2 + i * 0.06 + 0.5);
  });
}
function App() {
  ...
  const [optionsInput, setOptionsInput] = reactExports.useState(savedOptions);
  const parsedOptions = optionsInput.split(",").map((o2) => o2.trim()).filter((o2) => o2.length > 0);
  const wheelOptions = parsedOptions.length >= 2 ? parsedOptions : DEFAULT_WHEEL_OPTIONS;
  const [result, setResult] = reactExports.useState(null);
  const [resultCategory, setResultCategory] = reactExports.useState("The wheel has spoken");
  const [confettiActive, setConfettiActive] = reactExports.useState(false);
  const [isSpinning, setIsSpinning] = reactExports.useState(false);
  const { count: dailyCount, increment } = useDailyCount();
  const wheelSectionRef = reactExports.useRef(null);
  const quickSectionRef = reactExports.useRef(null);
  const resultSectionRef = reactExports.useRef(null);
  const scrollTo = reactExports.useCallback((id) => {
    const el = id === "wheel" ? wheelSectionRef.current : quickSectionRef.current;
    el == null ? void 0 : el.scrollIntoView({ behavior: "smooth", block: "start" });
  }, []);
  const handleResult = reactExports.useCallback(
    (res, category = "The wheel has spoken") => {
      setResult(res);
      ...
      setTimeout(() => {
        var _a2;
        (_a2 = resultSectionRef.current) == null ? void 0 : _a2.scrollIntoView({
          behavior: "smooth",
          block: "center"
        });
      }, 200);
  ...
  const handleSpinStart = reactExports.useCallback(() => {
    setIsSpinning(true);
    setResult(null);
    playSpinSound(4);
  }, []);
  ...
  const triggerSpin = () => {
    ...
    canvas == null ? void 0 : canvas.click();
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-app-gradient min-h-dvh", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Confetti, { active: confettiActive }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "mx-auto max-w-5xl px-5 pb-20 pt-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "section",
        {
          ref: wheelSectionRef,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "h1",
                {
                  ...
                  children: [
                    "Can't Decide?",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(var(--primary))" }, children: "Spin it." })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "text-base",
                  style: { color: "oklch(var(--muted-foreground))" },
                  children: "The most scientific decision-making tool known to humankind."
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pulse-glow-anim relative rounded-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              SpinWheel,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      style: { color: "oklch(var(--muted-foreground))" },
                      children: "Enter comma-separated options (min 2)"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "textarea",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { ref: quickSectionRef, id: "quick", children: /* @__PURE__ */ jsxRuntimeExports.jsx(QuickDecisions, { onResult: (res, cat) => handleResult(res, cat) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "footer",
      {
